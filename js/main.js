...
mapaBackground.src = '/img/mapa.webp';

/* Creando una clase*/
class Mokepon {
  constructor(nombre, foto, ataque, vida) {
    this.nombre = nombre;
    this.foto = foto;
    this.vida = vida;
    this.ataques = [];
...
function iniciarJuego() {
  ...
  /* colocando las etiquetas de los mokepones en el html  */
...
function sePrecionoUnaTecla(evento) {
  switch (event.key) {
    case 'ArrowUp':
      moverArriba();
      break;
